...
- Native Vulkan/AHardwareBuffer presentation is never reported unless a native executor imports,
  presents and measures the output. YCore owns the ordinary FFmpeg software fallback; the shipping
  high-quality GPU and Dolby-specialized fallback remains explicitly labelled libmpv/libplacebo.
