...
class PlaybackProgressReporterTest {
    @Test
    fun one_sink_exception_does_not_prevent_the_later_stop_attempt() =
        runTest {
    ...
    @Test
    fun reports_start_seek_transition_and_stop_in_order() =
        runTest {
    ...
    @Test
    fun natural_end_reports_stopped_without_waiting_for_screen_close() =
        runTest {
            val events = mutableListOf<Event>()
            val reporter =
                PlaybackProgressReporter(
     ...
     */
    @Test
    fun reports_carry_the_session_id_the_stream_urls_were_built_with() =
        runTest {
            val events = mutableListOf<Event>()
            val reporter =
                PlaybackProgressReporter(
    ...
    @Test
    fun version_handover_stops_old_session_and_reports_the_new_session() =
        runTest {
            val events = mutableListOf<Event>()
    ...
    @Test
    fun appending_an_episode_does_not_restart_the_active_session() =
        runTest {
            val events = mutableListOf<Event>()
            val first =
                PlayerMediaItem(
    ...
    @Test
    fun reordering_the_queue_follows_the_active_session_instead_of_the_old_numeric_index() =
        runTest {
            val events = mutableListOf<Event>()
            val first =
                PlayerMediaItem(
    ...
    @Test
    fun shrinking_the_queue_remaps_the_active_index_without_starting_the_session_twice() =
        runTest {
            val events = mutableListOf<Event>()
            val first =
                PlayerMediaItem(
    ...
    @Test
    fun recoverable_engine_error_does_not_delete_session_before_handover() =
        runTest {
            val events = mutableListOf<Event>()
            val item =
                PlayerMediaItem(
    ...
    @Test
    fun an_entry_without_a_session_id_still_gets_one() =
        runTest {
    ...
    @Test
    fun slow_sink_coalesces_seek_storm_and_closes_with_the_latest_state() =
        runTest {
            val events = mutableListOf<Event>()
