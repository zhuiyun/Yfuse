...
STAGE = ROOT / ".native-build/playback-optimization-20260920"
...
def main() -> None:
    ...
    for name in ("nativeSubtitleDisplaySetApiVersion", "nativeOpenCancellable", "nativeOpenWithAnalysis", "nativeCreateCancellation", "nativeRenderAss", "nativeDemuxHandleContractVersion"):
