...
$apk = 'D:/Demo/Yfuse/artifacts/releases/kernel-fixes-1.0.74-236/Yfuse-1.0.74-236-full-arm64-signed.apk'
...
$stage = 'D:/Demo/Yfuse/audit/releases/20260920-kernel-fixes/publication'
...
[[ "$(sha256sum "$v2_manifest" | awk '{print $1}')" == "8a1b4b9cded78f318e43c5e2c76e8f004ab086fae56e9b9dddc65ef00ba06abb" ]] || { echo "Production v2 manifest changed since preflight" >&2; exit 4; }
...
# Historical APK pruning intentionally omitted for this publication.
