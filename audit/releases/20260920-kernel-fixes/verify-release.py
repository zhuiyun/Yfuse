...
def main():
    ...
    parser.add_argument("--previous-apk", type=Path, default=ROOT / (
        "artifacts/releases/glass-backdrop-fix-1.0.73-235/Yfuse-1.0.73-235-full-arm64-signed.apk"))
    ...
    require(previous.get("versionName") == "1.0.73" and previous.get("versionCode") == "235",
            "Expected verified latest delivered baseline 1.0.73 (235)")
    ...
    require(current.get("versionName") == properties.get("VERSION_NAME") == "1.0.74", "Version name mismatch")
    require(current.get("versionCode") == properties.get("VERSION_CODE") == "236", "Version code mismatch")
