...
& .\gradlew.bat :phoneShared:testAndroidHostTest --tests com.yfuse.core.data.ThemePreferencesTest --tests com.yfuse.core.designsystem.GlassMaterialTest --tests com.yfuse.core.designsystem.GlassTest --tests com.yfuse.core.designsystem.LoadingAnimationTest --tests com.yfuse.core.designsystem.LoadingMotionTest :composeApp:verifyDesignSystemUsage :composeApp:assembleRelease `
