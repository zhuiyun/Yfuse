...
& .\gradlew.bat :phoneShared:testAndroidHostTest --tests com.yfuse.core.data.ThemePreferencesTest --tests com.yfuse.core.designsystem.GlassMaterialTest --tests com.yfuse.core.designsystem.GlassTest --tests com.yfuse.core.designsystem.BackdropFramesTest --tests com.yfuse.core.designsystem.OverlayVisibilityTest :composeApp:verifyDesignSystemUsage :composeApp:assembleRelease `
