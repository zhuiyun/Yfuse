...
OUT = ROOT / "artifacts-local/releases/code-cleanup-1.0.84-246"
TOOLS = Path("D:/AndroidSDK/build-tools/36.1.0")
JAVA = Path("D:/software/android-studio-2024.1.1.11-windows/android-studio/jbr/bin/java.exe")
PREVIOUS = (
    ROOT
    / "artifacts/releases/preheat-fix-1.0.83-245"
    / "Yfuse-1.0.83-245-full-arm64-signed.apk"
)
...
def main() -> None:
    ...
    require(version_name == "1.0.84" and version_code == 246, "Unexpected project version")
    ...
    for log in ("full-build.log", "compact-build.log"):
