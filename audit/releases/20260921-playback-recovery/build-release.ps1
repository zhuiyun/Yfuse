...
& .\gradlew.bat :phoneShared:testAndroidHostTest --tests 'com.yfuse.core2.*' --tests 'com.yfuse.feature.player.PlaybackDiagnosticsTest' --tests 'com.yfuse.update.*' :composeApp:verifyDesignSystemUsage :composeApp:assembleRelease `
