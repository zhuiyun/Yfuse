...
def main():
    ...
    require(previous.get("versionName") == "1.0.76" and previous.get("versionCode") == "238",
            "Expected verified latest delivered baseline 1.0.76 (238)")
    ...
    require(current.get("versionName") == properties.get("VERSION_NAME") == "1.0.77", "Version name mismatch")
    require(current.get("versionCode") == properties.get("VERSION_CODE") == "239", "Version code mismatch")
