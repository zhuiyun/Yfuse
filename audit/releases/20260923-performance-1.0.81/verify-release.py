...
OUT = ROOT / "artifacts/releases/performance-1.0.81-243"
TOOLS = Path("D:/AndroidSDK/build-tools/36.0.0")
JAVA = Path("C:/Users/app-inkbird/.jdks/ms-21.0.9/bin/java.exe")
PREVIOUS = (
    ROOT
    / "artifacts/releases/dialog-restore-1.0.79-241"
    / "Yfuse-1.0.79-241-full-arm64-signed.apk"
)
...
def main() -> None:
    ...
    require(version_name == "1.0.81" and version_code == 243, "Unexpected project version")
    ...
    for log in ("full-build-retry.log", "compact-build.log"):
