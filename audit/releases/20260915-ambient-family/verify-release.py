...
OUT = ROOT / 'artifacts/releases/ambient-family-1.0.56-218'
APK = OUT / 'Yfuse-1.0.56-218-full-arm64-signed.apk'
PREVIOUS = ROOT / 'artifacts/releases/search-field-1.0.55-217/Yfuse-1.0.55-217-search-field-full-arm64-signed.apk'
...
require(current.get('versionName') == properties['VERSION_NAME'] == '1.0.56', 'Version name mismatch')
require(current.get('versionCode') == properties['VERSION_CODE'] == '218', 'Version code mismatch')
...
report = {
    ...
    'tests': {'composeApp': 2576, 'tvApp': 63, 'failures': 0, 'newAmbientRegressions': 8},
