...
- APK：`Yfuse-1.0.65-227-full-arm64-signed.apk`
- 应用 ID：`com.yfuse`；版本：**1.0.65（227）**，高于实际上一包 1.0.64（226）。
...
- 正式证书 SHA256：`373e36d363965b6c1ae0a68c3db9537831d137ea6c38f094608bf243e7be3e84`，与上一实际交付包相同。
...
- 客户端、TV、服务端与协议：共 **2887 项测试通过**，无失败、错误或跳过。
