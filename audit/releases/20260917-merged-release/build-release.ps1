...
& '.\.gradle-tmp\wrapper\dists\gradle-9.5.0-bin\bvnork1r7n8i6kp5cnkibsc9q\gradle-9.5.0\bin\gradle.bat' `
    :composeApp:verifyDesignSystemUsage :phoneShared:ktlintCheck :tvShared:ktlintCheck :phoneShared:testAndroidHostTest :tvShared:testAndroidHostTest :tvApp:compileDebugKotlin :composeApp:assembleRelease `
...
Copy-Item -LiteralPath 'composeApp/build/outputs/apk/release/composeApp-release.apk' `
    -Destination 'artifacts/releases/merged-1.0.68-230/Yfuse-1.0.68-230-full-arm64-signed.apk'
