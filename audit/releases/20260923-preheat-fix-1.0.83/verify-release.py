...
OUT = ROOT / "artifacts/releases/preheat-fix-1.0.83-245"
TOOLS = Path("D:/AndroidSDK/build-tools/36.0.0")
JAVA = Path("C:/Users/app-inkbird/.jdks/ms-21.0.9/bin/java.exe")
PREVIOUS = (
    ROOT
    / "artifacts/releases/playback-fix-1.0.82-244"
    / "Yfuse-1.0.82-244-full-arm64-signed.apk"
)
...
def main() -> None:
    ...
    require(version_name == "1.0.83" and version_code == 245, "Unexpected project version")
