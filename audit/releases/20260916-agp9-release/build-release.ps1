...
& '.\.gradle-tmp\wrapper\dists\gradle-9.5.0-bin\bvnork1r7n8i6kp5cnkibsc9q\gradle-9.5.0\bin\gradle.bat' `
    :composeApp:verifyDesignSystemUsage :phoneShared:testAndroidHostTest :composeApp:assembleRelease `
...
Copy-Item -LiteralPath 'composeApp/build/outputs/apk/release/composeApp-release.apk' `
    -Destination 'artifacts/releases/agp9-1.0.67-229/Yfuse-1.0.67-229-full-arm64-signed.apk'
