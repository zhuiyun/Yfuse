"""Verify the signed 1.0.49 package and save evidence for this build only.
...
APK_NAME = "Yfuse-1.0.49-signed-arm64.apk"
...
SUITES = (
    ...
    "com.yfuse.core.designsystem.AmbientLightTest",
    "com.yfuse.core.data.PlaybackPreferencesTest",
    "com.yfuse.feature.player.AmbientCopyTest",
    "com.yfuse.feature.player.Core2SurfaceTest",
...
def verify_snapshot():
    ...
    required_sources = {
        "androidMain/kotlin/com/yfuse/feature/player/AmbientCopy.kt",
        "androidMain/kotlin/com/yfuse/feature/player/AmbientFrameSampler.kt",
        "androidUnitTest/kotlin/com/yfuse/feature/player/AmbientCopyTest.kt",
...
def main():
    ...
    require(package_values.get("versionCode") == "211", "APK versionCode is not 211")
    require(package_values.get("versionName") == "1.0.49", "APK versionName is not 1.0.49")
    ...
    print("PASS: com.yfuse / 1.0.49 (211) / ARM64, production signature, ZIP alignment and size")
    ...
    report = {
        ...
        "versionSource": "Gradle overrides yfuseVersionName=1.0.49 and yfuseVersionCode=211",
        "testScope": "Ambient sampling cancellation and crop geometry, ambient color extraction, playback preferences, surface geometry, search and navigation motion from the frozen Kotlin snapshot",
        "evidence": {
