...
ROOT = OUT.parents[2]
APK = OUT / 'Yfuse-1.0.51-signed-arm64.apk'
...
require(values.get('versionName') == '1.0.51' and values.get('versionCode') == '213', 'Wrong version')
...
report = {
    ...
    'apk': APK.name, 'applicationId': 'com.yfuse', 'versionName': '1.0.51', 'versionCode': 213,
    ...
    'previousRegressionEvidence': '../../motion-optimization-20260910/RESULTS.md',
