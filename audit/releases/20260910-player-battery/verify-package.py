...
ROOT = OUT.parents[2]
APK = OUT / 'Yfuse-1.0.52-signed-arm64.apk'
...
require(values.get('versionName') == '1.0.52' and values.get('versionCode') == '214', 'Wrong version')
...
report = {
    ...
    'apk': APK.name, 'applicationId': 'com.yfuse', 'versionName': '1.0.52', 'versionCode': 214,
...
(OUT / 'README.md').write_text(
    ...
    '包含播放控制栏电量与充电标记、主题消费点颜色过渡、播放运行区实时状态隔离、ASS 绘制隔离，'
