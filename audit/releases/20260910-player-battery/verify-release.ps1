...
$apk = Join-Path $PSScriptRoot 'Yfuse-1.0.52-signed-arm64.apk'
...
$env:PYTHONUTF8 = '1'
& 'C:\Users\app-inkbird\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe' (Join-Path $PSScriptRoot 'verify-package.py')
