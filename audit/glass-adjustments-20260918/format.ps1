...
$stageRoot = Join-Path $taskRoot 'audit/glass-adjustments-20260918/format-stage'
$sourcePaths = @(
    ...
    'composeApp/src/commonMain/kotlin/com/yfuse/core/designsystem/GlassAdjustment.kt',
    'composeApp/src/commonMain/kotlin/com/yfuse/feature/profile/ProfileScreen.kt'
)
...
& 'C:\Users\app-inkbird\.jdks\ms-21.0.9\bin\java.exe' -cp ($jars -join ';') com.pinterest.ktlint.Main --format @staged > audit/glass-adjustments-20260918/format-files.log 2>&1
$formatResult = $LASTEXITCODE
Get-Content audit/glass-adjustments-20260918/format-files.log -Tail 45
