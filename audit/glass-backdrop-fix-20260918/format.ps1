...
$stageRoot = Join-Path $taskRoot 'audit/glass-backdrop-fix-20260918/format-stage'
$sourcePaths = @(
    ...
    'composeApp/src/commonMain/kotlin/com/yfuse/core/designsystem/BackdropFrames.kt',
    'composeApp/src/commonTest/kotlin/com/yfuse/core/designsystem/BackdropFramesTest.kt',
    'composeApp/src/commonTest/kotlin/com/yfuse/core/designsystem/OverlayVisibilityTest.kt'
)
...
& 'C:\Users\app-inkbird\.jdks\ms-21.0.9\bin\java.exe' -cp ($jars -join ';') com.pinterest.ktlint.Main --format @staged > audit/glass-backdrop-fix-20260918/format-files.log 2>&1
$formatResult = $LASTEXITCODE
Get-Content audit/glass-backdrop-fix-20260918/format-files.log -Tail 45
