...
& $gradle @reviewArguments 2>&1 | Tee-Object -FilePath (Join-Path $PSScriptRoot 'build-review.log')
if ($LASTEXITCODE -ne 0) { throw 'Workspace review checks failed; inspect build-review.log.' }
