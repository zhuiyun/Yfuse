...
$stageRoot = Join-Path $taskRoot 'audit/glass-material-20260918/format-stage'
$sourcePaths = @(
    ...
    'composeApp/src/androidMain/kotlin/com/yfuse/feature/player/PlayerActivity.kt',
    'tvApp/src/androidMain/kotlin/com/yfuse/tv/ui/TvSettingsScreen.kt'
)
...
& 'C:\Users\app-inkbird\.jdks\ms-21.0.9\bin\java.exe' -cp ($jars -join ';') com.pinterest.ktlint.Main --format @staged > audit/glass-material-20260918/format-files.log 2>&1
$formatResult = $LASTEXITCODE
Get-Content audit/glass-material-20260918/format-files.log -Tail 45
