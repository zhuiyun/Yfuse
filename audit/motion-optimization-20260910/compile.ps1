...
& $gradle @reviewArguments 2>&1 | Tee-Object -FilePath (Join-Path $PSScriptRoot 'compile.log')
if ($LASTEXITCODE -ne 0) { throw 'Workspace review checks failed; inspect compile.log.' }
