...
$resultRoot = Join-Path $taskRoot 'audit/kernel-fixes-20260920/ownership'
...
$sources = @(
    'composeApp/src/androidMain/kotlin/com/yfuse/feature/player/NativeCrashContextOwnership.kt'
    'composeApp/src/androidUnitTest/kotlin/com/yfuse/feature/player/NativeCrashContextOwnershipTest.kt'
...
& $java -cp (($runtime + $classes) -join ';') org.junit.runner.JUnitCore com.yfuse.feature.player.NativeCrashContextOwnershipTest > (Join-Path $resultRoot 'tests.log') 2>&1
