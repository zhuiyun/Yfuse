...
$stageRoot = Join-Path $taskRoot 'audit/handoff-status-20260917/format-stage'
$sourcePaths = @(
    'composeApp/src/commonMain/kotlin/com/yfuse/core/handoff/HandoffApi.kt',
    'composeApp/src/commonMain/kotlin/com/yfuse/core/handoff/HandoffController.kt',
    'composeApp/src/commonMain/kotlin/com/yfuse/feature/handoff/DeviceHandoffScreen.kt',
    'composeApp/src/commonMain/kotlin/com/yfuse/feature/player/PlayerSettingsPanel.kt',
    'composeApp/src/commonTest/kotlin/com/yfuse/core/handoff/HandoffControllerTest.kt',
    'composeApp/src/commonTest/kotlin/com/yfuse/core/handoff/AccountHandoffApiTest.kt'
)
...
& 'C:\Users\app-inkbird\.jdks\ms-21.0.9\bin\java.exe' -cp ($jars -join ';') com.pinterest.ktlint.Main --format @staged > audit/handoff-status-20260917/format-files.log 2>&1
$formatResult = $LASTEXITCODE
Get-Content audit/handoff-status-20260917/format-files.log -Tail 45
