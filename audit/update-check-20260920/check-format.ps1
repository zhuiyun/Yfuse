...
$sources = @(
 ...
 'composeApp/src/androidUnitTest/kotlin/com/yfuse/update/UpdateManifestPolicyTest.kt'
)
& 'C:/Users/app-inkbird/.jdks/ms-21.0.9/bin/java.exe' -cp ($jars -join ';') com.pinterest.ktlint.Main @sources > audit/update-check-20260920/format-check.log 2>&1
$result = $LASTEXITCODE
Get-Content audit/update-check-20260920/format-check.log -Tail 25
exit $result
