...
$tasks = switch ($Mode) {
    ...
    test { @(':phoneShared:testAndroidHostTest', ':tvShared:testAndroidHostTest', ':composeApp:compileDebugKotlin', ':tvApp:compileDebugKotlin', ':phoneShared:playbackVerificationReport', ':tvShared:playbackVerificationReport') }
...
& .\gradlew.bat @tasks `
    ...
    -I audit/playback-followup-fix-20260920/isolated-results.init.gradle `
