...
class LibraryStoreTest {
    ...
    @Test
    fun token_rotation_with_the_same_server_id_reloads_the_home() =
        runTest {
            val oldRequestStarted = CompletableDeferred<Unit>()
            val releaseOldRequest = CompletableDeferred<Unit>()
            val oldRequestSettled = CompletableDeferred<Unit>()
    ...
    @Test
    fun token_rotation_does_not_replace_fresh_memory_with_an_old_cache_snapshot() =
        runTest {
    ...
    @Test
    fun cachedColdStartBecomesLiveAndAdvancesTimestamp() =
        runTest {
    ...
    @Test
    fun cachedFailureKeepsContentAndMarksItOffline() =
        runTest {
