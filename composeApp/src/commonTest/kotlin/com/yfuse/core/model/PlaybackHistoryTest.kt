...
class PlaybackHistoryTest {
    ...
    fun seriesKeepsTheMostRecentlyWatchedEpisodeAndItsExactProgress() {
        val old = item("ep2", "Episode", "Reacher", "show").copy(
            lastPlayedDate = "2026-09-06T09:00:00Z", resumePositionTicks = 800L,
        )
        val recent = old.copy(
            id = "ep1", lastPlayedDate = "2026-09-06T10:00:00Z", resumePositionTicks = 100L,
        )
    ...
    fun movieVersionsUseProviderIdentityAndKeepTheLatestSource() {
        ...
        val recent = item("movie-b", title = "Translated title").copy(
            providerIds = mapOf("tmdb" to "123"), lastPlayedDate = "2026-09-06T10:00:00Z",
        )
    ...
    private fun item(
        ...
        id = id, title = title, subtitle = null, type = type,
        posterItemId = posterId, posterTag = null, backdropItemId = null, backdropTag = null,
        playedPercentage = 10.0, year = 2026,
    )
}
