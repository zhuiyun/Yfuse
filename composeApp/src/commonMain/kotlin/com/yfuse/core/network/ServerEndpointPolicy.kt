...
/** Media servers accept HTTP and HTTPS without a transport confirmation requirement. */
...
fun validateEmbyServerEndpoint(
    ...
    return ServiceEndpointValidation(
        ...
        decision =
            if (scheme == "https") EndpointTransportDecision.Secure else EndpointTransportDecision.Cleartext,
        message = null,
    )
}
