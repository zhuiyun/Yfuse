...
internal fun compareMediaVersionsBestFirst(left: MediaVersion, right: MediaVersion): Int =
    compareQuality(left.sortQuality(), right.sortQuality())

/** Negative means [left] is the better source and should appear first. */
internal fun compareSourceInfoBestFirst(left: SourceInfo?, right: SourceInfo?): Int =
    compareQuality(left.sortQuality(), right.sortQuality())

private fun MediaVersion.sortQuality(): MediaQuality = MediaQuality(
...
private fun SourceInfo?.sortQuality(): MediaQuality = MediaQuality(
...
private fun compareQuality(left: MediaQuality, right: MediaQuality): Int =
...
private fun resolutionPixels(width: Int?, height: Int?): Long? {
...
private fun dynamicRangeRank(dolbyVision: Boolean, range: String?): Int {
