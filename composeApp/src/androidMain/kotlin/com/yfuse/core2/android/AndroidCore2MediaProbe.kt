...
internal class AndroidCore2MediaProbe(
    ...
    fun returnPreparedExtractor(
        item: YMediaItem,
        source: YPlatformExtractorSource,
    ) = preparedExtractor.offer(item, source)
...
internal class AndroidCore2RouteEvaluator(
    ...
    private val enhancedProbe: AndroidEnhancedMediaProbe =
        AndroidEnhancedMediaProbe(context = context.applicationContext),
    ...
    fun takePreparedEnhancedDemux(item: YMediaItem): AndroidPreparedEnhancedDemux? =
        enhancedProbe.takePreparedDemux(item)
